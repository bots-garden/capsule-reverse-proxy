...
wget https://github.com/bots-garden/capsule/releases/download/${CAPSULE_REVERSE_PROXY_VERSION}/${MODULE}-${CAPSULE_REVERSE_PROXY_VERSION}-${CAPSULE_REVERSE_PROXY_OS}-${CAPSULE_REVERSE_PROXY_ARCH}.tar.gz
